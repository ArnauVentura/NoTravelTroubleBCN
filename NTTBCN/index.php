          ...
          <?php
            ...
            if ($_SESSION['usuario'] == "admin" && $_SESSION['contrasena'] == "2a2e9a58102784ca18e2605a4e727b5f") {
              ...
              $usuario = $_SESSION['usuario'];
                ...
                <li class="nav-item active">
                  <a id="mi_cuenta" class="nav-link" onclick="openPopup();"><?php echo $usuario ?></a>
                  <img id="mi_cuenta_img" src="./media/login_icon.png" onclick="openPopup();"
                  class="d-inline-block align-text-top">
                </li>
                <?php
      ...
      <div class="popup" id="popup">
        ...
        <form action="./index.php" method="post">
          <div class="mb-3">
            ...
            <input type="text" minlength="4" maxlength="12" class="form-control" id="usuario" name="usuario" aria-describedby="emailHelp">
          </div>
          <div class="mb-3">
