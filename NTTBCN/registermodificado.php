...
<head>
    ...
    <title>Accede a tu cuenta | NTTBCN</title>
...
<section>
    <div class="ventajas">
        ...
        <div class="info">
            ...
            <div id="text">
                <h2>Recibe Informacion Adicional</h2>
                <p></p>
            </div>
        </div>
    </div>
    ...
    <div class="login">
        <h1>Registro</h1>
        <div class="form">
            <form action="registermodificado.php" method="post">
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Usuario</label>
                    <input type="text" minlength="4" name="usuario" maxlength="12" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                </div>
                <div class="mb-3">
                ...
                <button name="registrado" type="submit" class="btn btn-primary">Registrarse</button>
            </form>
        </div>
